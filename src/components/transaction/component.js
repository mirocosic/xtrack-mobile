...
import Animated, { 
  // add, call, clockRunning, cond, eq, not, set, useCode, EasingNode, interpolateNode 
  useSharedValue,
  withSpring,
  useAnimatedStyle,
...
const Transaction = ({ transaction, selectTransaction, deleteTransaction, navigation, categories }) => {
  ...
  //     // cond(eq(state, State.ACTIVE), set(opacityTextSwipe, interpolateNode(translation.x, { inputRange: [-width + 100, 100], outputRange: [1, 0] }))),
